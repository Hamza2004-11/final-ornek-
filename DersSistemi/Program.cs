...
class Program
{
    ...
    static void ornekVerileriEkle()
    {
        ...
        {
            ogrenciler.Add(new Ogrenci { Isim = "Hamza Mintaş", OgrenciNo = "101" });
            ogrenciler.Add(new Ogrenci { Isim = "Salih Korkmaz", OgrenciNo = "102" });

            ogretimGorevlileri.Add(new OgretimGorevlisi { Isim = "Refik Tanju Sirmen", Bolum = "Bilgisayar Mühendisliği" });
            ogretimGorevlileri.Add(new OgretimGorevlisi { Isim = "Emrah Sarıçiçek", Bolum = "Yazılım MÜhendisliği" });

            var ders1 = new Ders { DersAdi = "Programlama 1", Kredi = 3, OgretimGorevlisi = ogretimGorevlileri[0] };
            var ders2 = new Ders { DersAdi = "Yazılım Mühendisliğine Giriş 1", Kredi = 4, OgretimGorevlisi = ogretimGorevlileri[1] };
